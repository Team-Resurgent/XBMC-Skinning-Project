...
{
	/// <summary>
	/// Summary description for FrmXButtonT.
	/// </summary>
	public class FrmXButtonT : System.Windows.Forms.Form
	{
		private Boolean FirstTime = true;

		//private CC_xButtonT cc_xButtonT;
		private FrmDesign f;
		private XButtonT xb;
		private XButtonT backupxb;
		...
		private System.Windows.Forms.PictureBox tickaltfocus;
		private System.Windows.Forms.PictureBox tickaltnofocus;
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(FrmXButtonT));
			...
			this.tickaltnofocus = new System.Windows.Forms.PictureBox();
			...
			this.tickaltfocus = new System.Windows.Forms.PictureBox();
			...
			// groupBox2
			// 
			this.groupBox2.Controls.Add(this.tickaltnofocus);
			...
			this.groupBox2.Controls.Add(this.tickaltfocus);
			this.groupBox2.Location = new System.Drawing.Point(8, 256);
			this.groupBox2.Name = "groupBox2";
			this.groupBox2.Size = new System.Drawing.Size(232, 88);
			this.groupBox2.TabIndex = 63;
			this.groupBox2.TabStop = false;
			this.groupBox2.Text = "Texture AltFocus";
			// 
			// tickaltnofocus
			// 
			this.tickaltnofocus.Image = ((System.Drawing.Image)(resources.GetObject("tickaltnofocus.Image")));
			this.tickaltnofocus.Location = new System.Drawing.Point(205, 56);
			this.tickaltnofocus.Name = "tickaltnofocus";
			this.tickaltnofocus.Size = new System.Drawing.Size(21, 23);
			this.tickaltnofocus.TabIndex = 70;
			this.tickaltnofocus.TabStop = false;
			this.toolTips.SetToolTip(this.tickaltnofocus, "Click to remove the image from this propertie");
			this.tickaltnofocus.Visible = false;
			this.tickaltnofocus.Click += new System.EventHandler(this.tickaltnofocus_Click);
			// 
			// btnrightfocus
			// 
			...
			// tickaltfocus
			// 
			this.tickaltfocus.Image = ((System.Drawing.Image)(resources.GetObject("tickaltfocus.Image")));
			this.tickaltfocus.Location = new System.Drawing.Point(205, 24);
			this.tickaltfocus.Name = "tickaltfocus";
			this.tickaltfocus.Size = new System.Drawing.Size(21, 23);
			this.tickaltfocus.TabIndex = 69;
			this.tickaltfocus.TabStop = false;
			this.toolTips.SetToolTip(this.tickaltfocus, "Click to remove the image from this propertie");
			this.tickaltfocus.Visible = false;
			this.tickaltfocus.Click += new System.EventHandler(this.tickaltfocus_Click);
			// 
			// groupBox1
			// 
			...
			this.groupBox1.Text = "Texture Focus";
			// 
			// ticknofocus
			// 
			this.ticknofocus.Image = ((System.Drawing.Image)(resources.GetObject("ticknofocus.Image")));
			this.ticknofocus.Location = new System.Drawing.Point(205, 56);
			this.ticknofocus.Name = "ticknofocus";
			this.ticknofocus.Size = new System.Drawing.Size(24, 26);
			this.ticknofocus.TabIndex = 68;
			...
			this.tickfocus.Location = new System.Drawing.Point(205, 24);
			this.tickfocus.Name = "tickfocus";
			this.tickfocus.Size = new System.Drawing.Size(24, 24);
			this.tickfocus.TabIndex = 67;
		...
		public void UpdateControl()
		{
			...
			if (this.txtrightfocus.Text != "-")
			{
				...
				picb.Picwidth = (Image.FromFile(picb.Path.ToString()).Width).ToString();
				picb.Pichieght = (Image.FromFile(picb.Path.ToString()).Height).ToString();
				xb.Picture.Add("AltTextureFocus",picb);
			}
			else
			{
				Picture pica = new Picture();
				pica.Path = "-";
				xb.Picture.Add("AltTextureFocus",pica);
			}
			...
			if (this.txtrightnofocus.Text != "-")
			{
				...
				picb.Picwidth = (Image.FromFile(picb.Path.ToString()).Width).ToString();
				picb.Pichieght = (Image.FromFile(picb.Path.ToString()).Height).ToString();
				xb.Picture.Add("AltTextureNoFocus",picb);
			}
			else
			{
				Picture pica = new Picture();
				pica.Path = "-";
				xb.Picture.Add("AltTextureNoFocus",pica);
			}
		...
		private void FrmXButtonT_Load(object sender, System.EventArgs e)
		{
			...
			else
			{
				...
				if (this.txtrightfocus.Text != "-")
				{
					this.tickaltfocus.Visible = true;
				}

				if (this.txtrightnofocus.Text != "-")
				{
					this.tickaltnofocus.Visible = true;
				}
		...
		private void tickaltfocus_Click(object sender, System.EventArgs e)
		{
			this.txtrightfocus.Text = "-";
			this.tickaltfocus.Visible = false;
		}

		private void tickaltnofocus_Click(object sender, System.EventArgs e)
		{
			this.txtrightnofocus.Text = "-";
			this.tickaltnofocus.Visible = false;
		}
