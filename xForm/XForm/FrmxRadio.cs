...
{
	/// <summary>
	/// Summary description for FrmxRadio.
	/// </summary>
	public class FrmxRadio : System.Windows.Forms.Form
	{
		private Boolean FirstTime = true;

		private CC_xRadio cc_xRadio;
		private FrmDesign f;
		private XRadio xb;
		private XRadio backupxb;
		...
		private System.Windows.Forms.PictureBox tickradionofocus;
		private System.Windows.Forms.PictureBox tickradiofocus;
		private System.Windows.Forms.Button btnradiofocus;
		private System.Windows.Forms.Button btnradionofocus;
		private System.Windows.Forms.TextBox txtradiofocus;
		private System.Windows.Forms.TextBox txtradionofocus;
		...
		public CC_xRadio cc_XRadio
		{
			get {return this.cc_xRadio;}
			set {this.cc_xRadio = value;}
		}
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(FrmxRadio));
			this.toolTips = new System.Windows.Forms.ToolTip(this.components);
			this.ticknofocus = new System.Windows.Forms.PictureBox();
			this.tickfocus = new System.Windows.Forms.PictureBox();
			this.tickradionofocus = new System.Windows.Forms.PictureBox();
			this.tickradiofocus = new System.Windows.Forms.PictureBox();
			this.gBoxProperties = new System.Windows.Forms.GroupBox();
			this.txtradionofocus = new System.Windows.Forms.TextBox();
			this.txtradiofocus = new System.Windows.Forms.TextBox();
			this.btnradiofocus = new System.Windows.Forms.Button();
			this.btnradionofocus = new System.Windows.Forms.Button();
			...
			this.ticknofocus.Location = new System.Drawing.Point(208, 200);
			...
			this.tickfocus.Location = new System.Drawing.Point(208, 168);
			...
			// tickradionofocus
			// 
			this.tickradionofocus.Image = ((System.Drawing.Image)(resources.GetObject("tickradionofocus.Image")));
			this.tickradionofocus.Location = new System.Drawing.Point(208, 264);
			this.tickradionofocus.Name = "tickradionofocus";
			this.tickradionofocus.Size = new System.Drawing.Size(24, 24);
			this.tickradionofocus.TabIndex = 68;
			this.tickradionofocus.TabStop = false;
			this.toolTips.SetToolTip(this.tickradionofocus, "Click to remove the image from this propertie");
			this.tickradionofocus.Visible = false;
			this.tickradionofocus.Click += new System.EventHandler(this.tickradionofocus_Click);
			// 
			// tickradiofocus
			// 
			this.tickradiofocus.Image = ((System.Drawing.Image)(resources.GetObject("tickradiofocus.Image")));
			this.tickradiofocus.Location = new System.Drawing.Point(208, 232);
			this.tickradiofocus.Name = "tickradiofocus";
			this.tickradiofocus.Size = new System.Drawing.Size(24, 24);
			this.tickradiofocus.TabIndex = 67;
			this.tickradiofocus.TabStop = false;
			this.toolTips.SetToolTip(this.tickradiofocus, "Click to remove the image from this propertie");
			this.tickradiofocus.Visible = false;
			this.tickradiofocus.Click += new System.EventHandler(this.tickradiofocus_Click);
			// 
			// gBoxProperties
			// 
			this.gBoxProperties.Controls.Add(this.txtradionofocus);
			this.gBoxProperties.Controls.Add(this.txtradiofocus);
			this.gBoxProperties.Controls.Add(this.tickradionofocus);
			this.gBoxProperties.Controls.Add(this.tickradiofocus);
			this.gBoxProperties.Controls.Add(this.btnradiofocus);
			this.gBoxProperties.Controls.Add(this.btnradionofocus);
			...
			this.gBoxProperties.TabIndex = 3;
			this.gBoxProperties.TabStop = false;
			this.gBoxProperties.Text = "Radio Properties";
			// 
			// txtradionofocus
			// 
			this.txtradionofocus.Location = new System.Drawing.Point(88, 8);
			this.txtradionofocus.Name = "txtradionofocus";
			this.txtradionofocus.Size = new System.Drawing.Size(32, 20);
			this.txtradionofocus.TabIndex = 70;
			this.txtradionofocus.Text = "";
			this.txtradionofocus.Visible = false;
			// 
			// txtradiofocus
			// 
			this.txtradiofocus.Location = new System.Drawing.Point(128, 8);
			this.txtradiofocus.Name = "txtradiofocus";
			this.txtradiofocus.Size = new System.Drawing.Size(32, 20);
			this.txtradiofocus.TabIndex = 69;
			this.txtradiofocus.Text = "";
			this.txtradiofocus.Visible = false;
			// 
			// btnradiofocus
			// 
			this.btnradiofocus.FlatStyle = System.Windows.Forms.FlatStyle.System;
			this.btnradiofocus.Location = new System.Drawing.Point(24, 232);
			this.btnradiofocus.Name = "btnradiofocus";
			this.btnradiofocus.Size = new System.Drawing.Size(176, 24);
			this.btnradiofocus.TabIndex = 65;
			this.btnradiofocus.Text = "Browse For RadioFocus ";
			this.btnradiofocus.Click += new System.EventHandler(this.btnradiofocus_Click);
			// 
			// btnradionofocus
			// 
			this.btnradionofocus.FlatStyle = System.Windows.Forms.FlatStyle.System;
			this.btnradionofocus.Location = new System.Drawing.Point(24, 264);
			this.btnradionofocus.Name = "btnradionofocus";
			this.btnradionofocus.Size = new System.Drawing.Size(176, 24);
			this.btnradionofocus.TabIndex = 66;
			this.btnradionofocus.Text = "Browse For Radio NoFocus";
			this.btnradionofocus.Click += new System.EventHandler(this.btnradionofocus_Click);
			// 
			// reverse
			// 
			...
			// lblColor1
			// 
			this.lblColor1.Location = new System.Drawing.Point(8, 344);
			...
			// txtdiffusecolor
			// 
			this.txtdiffusecolor.Location = new System.Drawing.Point(144, 368);
			...
			this.btnColorDefuse.Location = new System.Drawing.Point(104, 368);
			...
			// CboxLabel
			// 
			this.CboxLabel.Location = new System.Drawing.Point(56, 320);
			...
			// CboxFonts
			// 
			this.CboxFonts.Location = new System.Drawing.Point(56, 296);
			...
			this.lblFonts.Location = new System.Drawing.Point(8, 296);
			...
			// txtColorkey
			// 
			this.txtColorkey.Location = new System.Drawing.Point(144, 344);
			...
			this.btnColorkey.Location = new System.Drawing.Point(104, 344);
			this.btnColorkey.Name = "btnColorkey";
			this.btnColorkey.Size = new System.Drawing.Size(32, 20);
			this.btnColorkey.TabIndex = 40;
			this.btnColorkey.Click += new System.EventHandler(this.btnColorkey_Click);
			// 
			// btnIgnore
			// 
			...
			this.lblLabel.Location = new System.Drawing.Point(8, 320);
			...
			this.btnImageBrowse.Location = new System.Drawing.Point(24, 168);
			...
			// txtImage
			// 
			this.txtImage.Location = new System.Drawing.Point(168, 8);
			...
			this.btnImageBrowse2.Location = new System.Drawing.Point(24, 200);
			...
			this.ClientSize = new System.Drawing.Size(250, 480);
			this.Controls.Add(this.gBoxProperties);
			this.FormBorderStyle = System.Windows.Forms.FormBorderStyle.FixedToolWindow;
			this.Name = "FrmxRadio";
			this.TopMost = true;
			this.Load += new System.EventHandler(this.FrmxRadio_Load);
		...
		private void btnradiofocus_Click(object sender, System.EventArgs e)
		{
			if (this.openFileDialog1.ShowDialog() == DialogResult.OK)
			{
				String path = Path.GetFullPath(openFileDialog1.FileName);
				this.txtradiofocus.Text = Path.GetFullPath(openFileDialog1.FileName);

				tickradiofocus.Visible = true;

				this.toolTips.SetToolTip(this.btnradiofocus, Path.GetFileName(this.txtradiofocus.Text));
			}
		}

		private void btnradionofocus_Click(object sender, System.EventArgs e)
		{
			if (this.openFileDialog1.ShowDialog() == DialogResult.OK)
			{
				String path = Path.GetFullPath(openFileDialog1.FileName);
				this.txtradionofocus.Text = Path.GetFullPath(openFileDialog1.FileName);

				tickradionofocus.Visible = true;

				this.toolTips.SetToolTip(this.btnradionofocus, Path.GetFileName(this.txtradionofocus.Text));
			}
		}
		...
		private void btnColorkey_Click(object sender, System.EventArgs e)
		{
		...
		public void UpdateControl()
		{
			...
			if (this.txtradiofocus.Text == String.Empty)
			{
				this.txtradiofocus.Text = "-";
			}

			if (this.txtradionofocus.Text == String.Empty)
			{
				this.txtradionofocus.Text = "-";
			}
			...
			if (this.txtradiofocus.Text != "-")
			{
				Picture pica = new Picture();
				pica.Path = this.txtradiofocus.Text;
				pica.Picwidth = (Image.FromFile(pica.Path).Width).ToString();
				pica.Pichieght = (Image.FromFile(pica.Path).Height).ToString();
				xb.Picture.Add("textureRadioFocus",pica);
			}
			else
			{
				Picture pica = new Picture();
			...
			if (this.txtradionofocus.Text != "-")
			{
				Picture pica = new Picture();
				pica.Path = this.txtradionofocus.Text;
				pica.Picwidth = (Image.FromFile(pica.Path).Width).ToString();
				pica.Pichieght = (Image.FromFile(pica.Path).Height).ToString();
				xb.Picture.Add("textureRadioNoFocus",pica);
			}
			else
			{
				Picture pica = new Picture();
		...
		private void FrmxRadio_Load(object sender, System.EventArgs e)
		{
			...
			else
			{
				...
				this.txtradiofocus.Text = xb.Picture["textureRadioFocus"].Path;
				this.txtradionofocus.Text = xb.Picture["textureRadioNoFocus"].Path;
				...
				if (this.txtradiofocus.Text != "-")
				{
					this.tickradiofocus.Visible = true;
				}

				if (this.txtradionofocus.Text != "-")
				{
					this.tickradionofocus.Visible = true;
				}
		...
		private void tickradiofocus_Click(object sender, System.EventArgs e)
		{
			this.txtradiofocus.Text = "-";
			this.tickradiofocus.Visible = false;
		}

		private void tickradionofocus_Click(object sender, System.EventArgs e)
		{
			this.txtradionofocus.Text = "-";
			this.tickradionofocus.Visible = false;
		}
