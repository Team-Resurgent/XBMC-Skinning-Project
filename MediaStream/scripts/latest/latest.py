...
class Main:
    ...
    def _fetch_totals( self ):
        ...
        movies_totals = re.findall( "<field>(.+?)</field>", totals_xml, re.DOTALL )
        ...
        # set properties 
        self.WINDOW.setProperty( "Movies.Count" , movies_totals[ 0 ] )
        self.WINDOW.setProperty( "Movies.Watched" , movies_totals[ 1 ] )
        self.WINDOW.setProperty( "Movies.UnWatched" , str( int( movies_totals[ 0 ] ) - int( movies_totals[ 1 ] ) ) )
