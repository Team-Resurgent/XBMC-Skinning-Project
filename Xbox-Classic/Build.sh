...
XBMCTex -input media/Moonlight -output Moonlight.xpr -quality max -noprotect
XBMCTex -input media/Farenheit -output Farenheit.xpr -quality max -noprotect
